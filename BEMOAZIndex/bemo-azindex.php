...
function bemoazindex_get_filter(){
...
*/
	...
	for($i=0;$i<26;$i++)
	{
		...
		if($bemoazindex == "")	//Not selected -> link
			echo '<div><a href="'.$base_url.'index.php?bemoazindex='.$letter[$i].'">'.$letter[$i].'</a></div>';
